...
We perform the fast use of the semantic segmentation models on the remote sensing image with pytorch.  
<font color='darkorange'>**The user can perform the model training and validation by fast ssetting the parameters in the scripts/config.py file.** </font>
...
6. GMNet [[Paper]](https://www.tandfonline.com/doi/full/10.1080/17538947.2023.2198266) (Note: this model requires multiscale validation dataset)
...
## Todo   
1. improve 1_dset_check.ipynb based on the watset repo (to be built).     
2. remove dataloader and build a new dataloader repo. 
